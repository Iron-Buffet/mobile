...
import ExerciseScreen from "./screens/library/exercises";
import PartScreen from "./screens/library/parts";
import StyleScreen from "./screens/library/styles";
import CertifiedScreen from "./screens/workout/certified";
import DesignScreen from "./screens/workout/design";
import ManagementScreen from "./screens/workout";
...
const Drawer = createDrawerNavigator(
  {
    ...
    //APP
    NHDashboard: { screen: DashboardScreen },
    NHExercises: { screen: ExerciseScreen },
    NHParts: { screen: PartScreen },
    NHStyles: { screen: StyleScreen },
    NHCertified: { screen: CertifiedScreen },
    NHDesign: { screen: DesignScreen },
    NHManagement: { screen: ManagementScreen }
  },
  {
...
export default {
  components: { Root, AppNavigation, Wrapper }
};
</script>
